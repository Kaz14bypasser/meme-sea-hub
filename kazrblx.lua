...
local kazlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Kaz14bypasser/meme-sea-hub/main/lib%20hub%20memesea.lua"))()
local Window = kazlib:MakeWindow({ Title = "Kaz hub: Meme Sea", SubTitle = "by kazblx", SaveFolder = "Kaz-MemeSea.json" })
...
local _Discord = Tabs.Discord do
  _Discord:AddDiscordInvite({
    ...
    Invite = "https://discord.gg/UQjPG97yYV"
  })
end
